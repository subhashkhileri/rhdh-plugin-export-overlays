...
import { generateProjects } from "./e2e-test-utils/utils/generateProjects";
...
process.env.CHART_URL ??= "oci://quay.io/rhdh/chart";
process.env.RHDH_VERSION ??= "1.8";
process.env.INSTALLATION_METHOD ??= "operator";
...
export default defineConfig({
  ...
  reporter: [
    ...
    ["list"],
    ["junit", { outputFile: "e2e-test-report/results.junit.xml" }],
  ],
